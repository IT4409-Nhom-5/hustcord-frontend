...
const HomePage: React.FC = () => {
  return (
    <div className="min-h-screen w-full bg-[#404eed] font-sans relative overflow-hidden flex flex-col">
      {/* Navbar */}
      ...
      <div className="flex-1 flex items-center justify-center relative z-10 text-center px-4 pt-16 pb-24">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-white mb-10 max-w-3xl mx-auto leading-relaxed">
            ...where you can belong to a club, a gaming group, or a community.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link 
              to="/register" 
              className="w-full sm:w-auto px-8 py-4 bg-white text-[#23272a] font-medium text-lg rounded-full hover:text-[#5865f2] hover:shadow-xl transition-all"
            >
