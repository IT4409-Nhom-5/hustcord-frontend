      ...
      <div className="flex items-center text-white">
        {isMePage ? (
          <>
            ...
            <div className="w-[1px] h-6 bg-[#3f4147] mx-4"></div>
